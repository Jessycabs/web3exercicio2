package br.edu.ifspcjo.ads.web3.exercicio3.exceptionhandler;
...
@ControllerAdvice
public class Exercicio3ExceptionHadler extends ResponseEntityExceptionHandler {

    @Autowired
    private MessageSource messageSource;

    // JSON mal-formado ou atributo desconhecido
    @Override
    ...
    // recurso não encontrado (delete/update com id inexistente)
